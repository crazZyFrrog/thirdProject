  ...
  const faqs = [
    {
      ...
      answer: 'Стрижки и окрашивание, маникюр и педикюр (включая smart-педикюр), коррекция и окрашивание бровей и ресниц, причёски и укладки.'
    },
    {
      question: 'А если я не знаю, какая стрижка или услуга мне подойдёт?',
      answer: 'Перед работой проводится консультация. Подберём вариант с учётом ваших пожеланий и особенностей.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Через форму на сайте, по телефону +7 (4842) 55-95-72 или в WhatsApp +7 (902) 988-35-35.'
    }
  ]
